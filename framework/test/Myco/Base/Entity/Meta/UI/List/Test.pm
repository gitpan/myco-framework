package Myco::Base::Entity::Meta::UI::List::Test;
...
unit tests for features of Myco::Base::Entity::Meta::UI::List
...
=head1 SYNOPSIS
 ...
 ./testrun [-m] Myco::Base::Entity::Meta::UI::List::Test
 # run tests, GUI style
 ./tktestrun Myco::Base::Entity::Meta::UI::List::Test
...
my $class = 'Myco::Base::Entity::Meta::UI::List';
...
#	type => sub {
#                   my $test = shift;
#	            my $foo = Myco::Base::Entity::Meta::UI::List->new(name => 'bar');
...
##############################################################################
###
### Unit Tests for Myco::Base::Entity::Meta::UI::List
###
##############################################################################
...
L<Myco::Base::Entity::Meta::UI::List|Myco::Base::Entity::Meta::UI::List>,
